				...
				<c:if test="${listCount ne 0}">
					<c:forEach var="vo" items="${list}" varStatus="status">
						<tr>
							...
							<td class="right money"><fmt:formatNumber value="${vo.newesset - vo.oldesset}" pattern="#,###,###,###" /></td>
							<td class="right money"><fmt:formatNumber value="${vo.cybcash + vo.newesset - vo.oldesset}" pattern="#,###,###,###" /></td>
