				...
				<div class="terms">
					<table>
						...
						<tr>
							<td>
								<br>
								<p>개인정보 수집 및 이용<span class="star">*</span></p>
								<div class="termsDetail .font1">
						...
						<tr>
							<td class="red"><i class="fas fa-exclamation-triangle"></i>19세 미만은 가입 및 서비스 이용이 제한됩니다.</td>
						</tr>
						<tr>
						<td>&nbsp;</td>
						</tr>
					...
					<table class="w100">
						...
						<tr>
							<td colspan="2"><input type="password" name="bankPw" id="bankPw"
								class="pin1 reqInfo" placeholder="계좌 비밀번호를 입력해주세요." readonly></td>
						</tr>
						<tr>
							<td colspan="2">
								&nbsp;
						...
						<tr>
							...
							<td><label for="birthdate">생년월일</label><span class="alert" id="bdlabel"> 만 19세 이상만 가입할 수 있습니다.</span></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2"><input type="text" name="phone" id="phone" placeholder = "연락처를 숫자로만 입력해주세요."></td>
						</tr>
						<tr>
